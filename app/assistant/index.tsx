import { Animated, Dimensions, StyleSheet, useAnimatedValue, View, ViewStyle } from "react-native";
...
const RoomView = () => {
	...
	// Disconnect on native back press
	useEffect(() => {
	...
	return (
		...
		>
			...
			>
				<AgentVisualization style={styles.agentVisualization} isPaused={!isMicrophoneEnabled} />
			</Animated.View>
